...
def layers(vgg_layer3_out, vgg_layer4_out, vgg_layer7_out, num_classes):
    ...
    """
    # 1x1 convolution and upsample for vgg layers 7, 4 and 3
    conv1x1_7 = tf.layers.conv2d(vgg_layer7_out, num_classes, 1, padding='same',
                              kernel_regularizer=tf.contrib.layers.l2_regularizer(1e-3))

    output7 = tf.layers.conv2d_transpose(conv1x1_7, num_classes, 4, 2, padding='same',
                                         kernel_regularizer=tf.contrib.layers.l2_regularizer(1e-3))
    ...
    output4 = tf.layers.conv2d_transpose(conv1x1_4, num_classes, 4, 2, padding='same',
                                         kernel_regularizer=tf.contrib.layers.l2_regularizer(1e-3))

    conv1x1_3 = tf.layers.conv2d(vgg_layer3_out, num_classes, 1, padding='same',
                                         kernel_regularizer=tf.contrib.layers.l2_regularizer(1e-3))

    output3 = tf.layers.conv2d_transpose(conv1x1_3, num_classes, 4, 2, padding='same',
                                         kernel_regularizer=tf.contrib.layers.l2_regularizer(1e-3))

    #add and skip connections
    add_7_4 = tf.add(output7, conv1x1_4)


    conv1x1_add_7_4 = tf.layers.conv2d_transpose(add_7_4, num_classes, 4, 2, padding='same',
                                         kernel_regularizer=tf.contrib.layers.l2_regularizer(1e-3))

    add_7_4_3 = tf.add(conv1x1_add_7_4, conv1x1_3)

    output = tf.layers.conv2d_transpose(add_7_4_3, num_classes, 16, 8, padding='same',
                                         kernel_regularizer=tf.contrib.layers.l2_regularizer(1e-3))
